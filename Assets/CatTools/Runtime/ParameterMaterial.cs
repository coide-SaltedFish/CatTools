...
{
    [AddComponentMenu("CatTools/CT ParameterMaterial")]
    public class ParameterMaterial : CatAvatarComponent
    {
        [SerializeField]
        ...
        [SerializeField] 
        public List<SkinnedMeshRendererMaterialSlotEntry> materials = new();
        ...
        {
            isValid = GetComponentsInChildren<Renderer>(true).Length > 0;
        }
    }
}